    ...
    <main class='scroll-content-2'>
      ...
      <yd-cell-group title="营业执照信息（副本）">
        ...
        <yd-cell-item>
          ...
          <yd-textarea slot="right" v-model="businessSphere" placeholder="填写您的经营范围" maxlength="1000"></yd-textarea>
        </yd-cell-item>
        <div class="upload-container">
          <p class="tips">照片1M以下</p>
...
export default {
  ...
  watch: {
    // isSettlementAccount(newValue, oldValue) {
    //   if (newValue) {
